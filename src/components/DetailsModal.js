...
function DetailsModal(props) {
  ...
  return (
    <>
        ...
        <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-info-circle m-1" viewBox="0 0 16 16">
      ...
      <Modal
        ...
        <Modal.Body className='text-dark'>
            ...
            <a href='#' target='_blank' className='py-2'>See Video</a>
        </Modal.Body>
        <Modal.Footer>
